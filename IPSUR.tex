...
Here is a link to Section \ref{sec-Types-of-Data} in another file, and here is a \ref{sec:Types-of-Data}.  And here is a hyperlink way \ref{sec-2-1}
\section{Statistics}
\label{sec-1-2}
...
The output is telling us that \texttt{discoveries} is a \emph{time series} (see Section \href{file://.data-description}{Other Data Types} for more) of length 100. The entries are integers, and since they represent counts this is a good example of discrete quantitative data. We will take a closer look in the following sections.
