...
1. Find the probability of exactly 3 defectives in the sample, that is, find \(\P(X=3)\). 
...
1. Find the probability that there are at most 2 defectives in the sample, that is, compute \(\P(X\leq2)\).
...
1. Generate \(100,000\) observations of the random variable \(X\).
