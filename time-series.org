...
#+DESCRIPTION: This chapter covers basic methods for handling data collected over time.
#+KEYWORDS: time series statistics R
#+LANGUAGE:  en
...
---
layout: chapter
title: IPSUR - Time Series
previous: resampling.html
next: appendix.html
description: This chapter covers basic methods for handling data collected over time.
keywords: time series statistics R
---
...
<ul>
<li><a href="#sec-1">Time Series</a></li>
</ul>
</div>
</div>
