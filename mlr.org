...
#+begin_src R :exports code :results graphics :file img/splom-trees.png
library(lattice)
splom(trees)
#+end_src
...
#+begin_src latex 
  \begin{figure}[ht!]
    \includegraphics[width=5in, height=4in]{img/splom-trees.png}
...
#+begin_src R :exports none :results graphics :file img/3D-scatterplot-trees.png
library(scatterplot3d)
s3d <- with(trees, scatterplot3d(Girth, Height, Volume, pch = 16, highlight.3d = TRUE, angle = 60))
fit <- lm(Volume ~ Girth + Height, data = trees)
#+end_src
...
#+begin_src latex 
  \begin{figure}[ht!]
    \includegraphics[width=5in, height=4in]{img/3D-scatterplot-trees.png}
...
#+begin_src R :exports code :results graphics :file img/Scatterplot-Volume-Girth-trees.png
qplot(Girth, Volume, data = trees)
#+end_src

#+begin_src latex 
  \begin{figure}[ht!]
    \includegraphics[width=5in, height=4in]{img/Scatterplot-Volume-Girth-trees.png}
...
#+begin_src R :exports code :results graphics :file img/Fitting-the-Quadratic.png
...
#+begin_src latex
  \begin{figure}[ht!]
    \includegraphics[width=5in, height=4in]{img/Fitting-the-Quadratic.png}
